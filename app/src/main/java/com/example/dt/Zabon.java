...
public class Zabon extends AppCompatActivity {


    public static final long TIMER_VALUE            =   501000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zabon);
    }
        ...
        protected void onResume(){
            ...
            quizTimer                   =   new CountDownTimer(TIMER_VALUE, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    if(millisUntilFinished / 10000 <= 10){
                ...
                public void onFinish() {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Zabon.this);
        ...
        private void handleEnd(int score){
            ...
            Intent returnIntent = new Intent(Zabon.this, Main2.class);
        ...
        private void setSelectedOptionTrue() { selectedOption = true; }
        ...
        private void handleNext(final Question question, final String selectedAns){
            ...
            nextButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(!isOptionSelected()){
                        Toast.makeText(getApplicationContext(), "Пожалуйста, выберите ответ", Toast.LENGTH_SHORT).show();
                    }else{
                        questionNumber++;
